...
namespace CountingBot.Features.Commands
{
    ...
    {
        [Command("calculate")]
        [Description("Evaluates a mathematical expression and displays the result.")]
        ...
        public async Task EvaluateExpressionCommandAsync(CommandContext ctx, string equation)
        {
            ...
            {
                string emptyExprMsg = await _languageService.GetLocalizedStringAsync(
                    "EmptyExpressionMessage",
                    lang
                );
            ...
            try
            {
                ...
                string footerTemplate = await _languageService.GetLocalizedStringAsync(
                    "MathResultFooter",
                    lang
                );
                    ...
                    new DiscordMessageBuilder()
                        ...
                        .AddComponents(
                            new DiscordButtonComponent(
                                ...
                                $"translate_{titleKey}_{descriptionKey}_{footerKey}",
            ...
            catch (Exception ex)
            {
                ...
                string errorTemplate = await _languageService.GetLocalizedStringAsync(
                    "GenericErrorMessage",
                    lang
                );
